  ...
  return (
    <div className='about'>
        ...
        <div className="about-content">
          ...
          <p>A fusion of passion and precision Vikas goes beyond being a coach, he's court-side mentor dedicated to empowering players and fostering a deep love for the game. With a proven track record, Vikas's personalized coaching style focuses on unblocking each players and aspirations. Join Bardan's Journey</p>
