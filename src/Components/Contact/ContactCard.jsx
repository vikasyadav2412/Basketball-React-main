  ...
  return (
    <div className='contactCard'>
      <div className='contact-logo'>
        ...
        <p>Our dynamic training sessions are menticulously crafted by VIKAS, a seasoned coach with a proven track recorded...</p>
        <div className="contact-logo-icon">

          <a href="https://www.instagram.com/anuvik_yadav/" target='_blank'><FaInstagram /></a>

          <a href="https://www.facebook.com/MSVarunvikasBhai11421" target='_blank'><FaFacebook /></a>

          <a href="https://www.linkedin.com/in/vikas-yadav2412/" target='_blank'><FaLinkedin /></a>
